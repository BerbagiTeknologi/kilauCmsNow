...
@section('content')
    ...
    <div class="container">
        <div class="page-inner">
                ...
                <div class="card-body">
                    <form method="GET" class="row g-3 align-items-end">
                        <div class="col-md-3">
                            ...
                            <input type="date" name="start_date" value="{{ $dateValue($startDate) }}" class="form-control">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Tanggal akhir</label>
                            <input type="date" name="end_date" value="{{ $dateValue($endDate) }}" class="form-control">
                        </div>
            ...
            @elseif ($dashboard['realtimeError'])
                <div class="alert alert-warning">
                    {{ $dashboard['realtimeError'] }}
                </div>
            @elseif (! $dashboard['hasData'])
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $number($realtimeSummary['activeUsers']) }}</div>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $number($realtimeSummary['screenPageViews']) }}</div>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $number($realtimeSummary['eventCount']) }}</div>
                    ...
                    <div class="card analytics-panel">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered table-hover analytics-table">
                                ...
                                <tbody>
                                    @forelse ($realtime['devices'] as $row)
                                        <tr>
                    ...
                    <div class="card analytics-panel">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered table-hover analytics-table">
                                ...
                                <tbody>
                                    @forelse ($realtime['pages'] as $row)
                                        <tr>
                                            <td>{{ $row['unifiedScreenName'] ?: '-' }}</td>
                                            <td>{{ $number($row['screenPageViews']) }}</td>
                                            <td>{{ $number($row['activeUsers']) }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                    ...
                    <div class="card analytics-panel">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered table-hover analytics-table">
                                ...
                                <tbody>
                                    @forelse ($realtime['locations'] as $row)
                                        <tr>
                                            <td>{{ $row['country'] ?: '-' }}</td>
                                            <td>{{ $row['city'] ?: '-' }}</td>
                                            <td>{{ $number($row['activeUsers']) }}</td>
                    ...
                    <div class="card analytics-panel">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered table-hover analytics-table">
                                ...
                                <tbody>
                                    @forelse ($realtime['events'] as $row)
                                        <tr>
                                            <td>{{ $row['eventName'] ?: '-' }}</td>
                                            <td>{{ $number($row['eventCount']) }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="2" class="text-center text-muted">Belum ada data realtime.</td>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $number($summary['activeUsers']) }}</div>
                            </div>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $number($summary['newUsers']) }}</div>
                            </div>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $number($summary['returningUsers']) }}</div>
                            </div>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $number($summary['sessions']) }}</div>
                            </div>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $number($summary['screenPageViews']) }}</div>
                            </div>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $percent($summary['bounceRate']) }}</div>
                            </div>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value">{{ $duration($summary['averageSessionDuration']) }}</div>
                            </div>
                    ...
                    <div class="card analytics-card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                ...
                                <div class="metric-value" style="font-size: 22px;">{{ config('services.google_analytics.property_id') ?: '-' }}</div>
                            </div>
                    ...
                    <div class="card analytics-panel">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered table-hover analytics-table">
                                ...
                                <tbody>
                                    @forelse ($dashboard['events'] as $row)
                                        <tr>
                                            <td>{{ $row['eventName'] ?: '-' }}</td>
                                            <td>{{ $number($row['eventCount']) }}</td>
                                            <td>{{ $number($row['activeUsers']) }}</td>
                    ...
                    <div class="card analytics-panel">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered table-hover analytics-table">
                                ...
                                <tbody>
                                    @forelse ($dashboard['trafficSources'] as $row)
                                        <tr>
                                            <td>{{ $row['sessionPrimaryChannelGroup'] ?: '-' }}</td>
                    ...
                    <div class="card analytics-panel">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered table-hover analytics-table">
                                ...
                                <tbody>
                                    @forelse ($dashboard['highBouncePages'] as $row)
                                        <tr>
                                            <td>
                                                <strong>{{ $row['pageTitle'] ?: '-' }}</strong><br>
                                                <small class="text-muted">{{ $row['pagePath'] ?: '-' }}</small>
                                            </td>
                                            <td>{{ $number($row['screenPageViews']) }}</td>
                                            <td>{{ $percent($row['bounceRate']) }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                    ...
                    <div class="card analytics-panel">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered table-hover analytics-table">
                                ...
                                <tbody>
                                    @forelse ($dashboard['topPages'] as $row)
                                        <tr>
                                            <td>{{ $row['pageTitle'] ?: '-' }}</td>
                                            <td class="text-break">{{ $row['pagePath'] ?: '-' }}</td>
                                            <td>{{ $number($row['screenPageViews']) }}</td>
                                            <td>{{ $number($row['activeUsers']) }}</td>
                                            <td>{{ $duration($row['averageSessionDuration']) }}</td>
                                            <td>{{ $percent($row['bounceRate']) }}</td>
                                        </tr>
                                    @empty
                                        <tr>
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const newVsReturning = @json($dashboard['newVsReturning']);
