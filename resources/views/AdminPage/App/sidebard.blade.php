    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-primary">
                <!-- Home Section -->
                <li
                    class="nav-item {{ Request::routeIs('dashboard') || Request::routeIs('dashboard.analytics') || Request::routeIs('settingsmenu') || Request::routeIs('admin.users.*') ? 'active' : '' }} nav-category">
                    <p>Home</p>
                </li>
                ...
                <li
                    class="nav-item {{ Request::routeIs('testimoni') || Request::routeIs('faq') || Request::routeIs('mitra') || Request::routeIs('kontak') || Request::routeIs('berita') || Request::routeIs('profile-kilau') || Request::routeIs('admin.donasi.*') ? 'active' : '' }} nav-category">
                    <p>Ruang Kerja</p>
                </li>
