        ...
        <div class="d-flex align-items-center flex-wrap gap-4 small mb-3">
          ...
          <div class="d-flex align-items-center gap-4">
            ...
            <button id="likeBtn" type="button" class="btn p-0 border-0 bg-transparent d-flex align-items-center"
              data-ga-event="like_article" data-ga-article-slug="{{ $article->slug }}">
          ...
          <div class="ms-auto share-drop">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item share-wa" href="#" data-ga-event="share_article" data-ga-share-method="whatsapp" data-ga-article-slug="{{ $article->slug }}"><i class="fab fa-whatsapp text-success"></i> WhatsApp</a></li>
              <li><a class="dropdown-item share-fb" href="#" data-ga-event="share_article" data-ga-share-method="facebook" data-ga-article-slug="{{ $article->slug }}"><i class="fab fa-facebook text-primary"></i> Facebook</a></li>
              <li><a class="dropdown-item copy-link" href="#" data-ga-event="share_article" data-ga-share-method="copy_link" data-ga-article-slug="{{ $article->slug }}"><i class="fas fa-link"></i> Salin Link</a></li>
            </ul>
          </div>
        </div>
      ...
      <div class="latest-wrapper">
        @foreach($latest as $l)
          <a href="{{ url('artikel/'.$l['slug']) }}" class="text-decoration-none text-dark"
            data-ga-event="open_article" data-ga-article-slug="{{ $l['slug'] }}" data-ga-source="article_sidebar">
...
$(function () {
  ...
  function renderCard(a){
    return `<a href="{{ url('artikel') }}/${a.slug}" class="text-decoration-none text-dark" data-ga-event="open_article" data-ga-article-slug="${a.slug}" data-ga-source="article_sidebar">
      <div class="latest-card mb-3">
