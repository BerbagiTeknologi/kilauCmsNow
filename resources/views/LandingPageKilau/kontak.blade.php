                            ...
                            @foreach ($programs as $index => $program)
                                <div class="col-md-4 mb-3">
                                    <input type="radio" id="program_{{ $program->id }}" name="id_program"
                                        ...
                                        data-judul="{{ $program->judul }}" data-ga-change-event="select_contact_program"
                                        data-ga-program-id="{{ $program->id }}" data-ga-program-title="{{ $program->judul }}">
                            ...
                            @foreach ($kategoriMitra as $index => $kategori)
                                <div class="col-md-4 mb-2">
                                    <input type="radio" id="kategori_{{ $index }}" name="kategori_mitra"
                                        ...
                                        data-ga-partner-category="{{ $kategori }}">
...
@section('scripts')
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key={{ config('services.google_maps.api_key') }}&region=ID&language=id&libraries=places&callback=initAllMaps">
    </script>
