                        ...
                        <div class="carousel-inner">
                            ...
                            @empty
                                <div class="carousel-item active">
                                    <img src="{{ $program->thumbnail_image ? asset('storage/' . $program->thumbnail_image) : asset('assets/img/default.jpg') }}"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const affiliateSub = @json(session('user_id'));
        ...
        document.querySelectorAll('.btn-referral-share').forEach(function (btn) {
            ...
            btn.addEventListener('click', function () {
                if (!isAuthenticated || !affiliateSub) {
                    ...
                    const referralUrl = `{{ url('/program') }}/${programId}/referral/${encodeURIComponent(affiliateSub)}`;
