                ...
                <div class="col-12 text-section wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p class="sejarah-description mb-4 text-center">
                     ...
                     <p class="sejarah-description mb-4">
                        <?php echo e($sejarahs->first() ? strip_tags(str_replace('&nbsp;', ' ', $sejarahs->first()->deskripsi_sejarah)) : 'Sejarah Tidak Tersedia'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\Profile\profilSejarah.blade.php ENDPATH**/ ?>