...
<?php $__env->startSection('content'); ?>
    <section class="home">
        <a href="<?php echo e(url('/')); ?>" class="back-arrow">
        ...
        <div class="main-content">
            <div class="outer-box">
                ...
                <div class="colored-box" data-bs-toggle="modal" data-bs-target="#loginModal1">
                    <img src="<?php echo e(asset('assets/img/LogoKilau2.png')); ?>" alt="Logo Kilau CMS">
                ...
                <div class="colored-box" style="margin-top: 30px;" data-bs-toggle="modal" data-bs-target="#loginModal2">
                    <img src="<?php echo e(asset('assets/img/kilauomg.png')); ?>" alt="Logo Kilau Management">
                ...
                <div class="colored-box" style="margin-top: 30px;" data-bs-toggle="modal" data-bs-target="#loginModal3">
                    <img src="<?php echo e(asset('assets/img/kliniq.png')); ?>" alt="Logo Kilau KLINIQ">
                ...
                <div class="colored-box" data-bs-toggle="modal" data-bs-target="#loginModal4">
                    <img src="<?php echo e(asset('assets/img/logoBP.png')); ?>" alt="Logo Berbagi Pendidikan">
                    <i class="bi bi-book-fill"></i>
                    <span>BERBAGI PENDIDIKAN</span>
                </div>

                <div class="colored-box" data-bs-toggle="modal" data-bs-target="#loginModal5">
                    <img src="<?php echo e(asset('assets/img/bah.png')); ?>" alt="Logo Berbagi Bahagia">
                    <i class="bi bi-heart-fill"></i>
                    <span>BERBAGI BAHAGIA</span>
                </div>
                
                 <div class="colored-box" data-bs-toggle="modal" data-bs-target="#loginModal6">
                    <img src="<?php echo e(asset('assets/img/bt.jpg')); ?>" alt="Logo Berbagi Teknologi">
                    <i class="bi bi-heart-fill"></i>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo e(route('login')); ?>'">Login</button>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('Auth.App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\Auth\dashboardwebsitelogin.blade.php ENDPATH**/ ?>