...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $timeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($item->judul_timline); ?></td>
                                                <td><?php echo e($item->subjudul_timline); ?></td>
                                                <td>
                                                    <span
                                                        class="badge <?php echo e($item->status_timline == 'Aktif' ? 'badge-success' : 'badge-danger'); ?>">
                                                        <?php echo e($item->status_timline); ?>

                                                    </span>
                                                </td>
                                                <td>
                                                    <!-- Menampilkan ikon berdasarkan nama yang ada di database -->
                                                    <?php if($item->icon_timeline): ?>
                                                        <i class="fa <?php echo e($item->icon_timeline); ?>"
                                                ...
                                                <td>
                                                    <div class="btn-group gap-2" role="group">
                                                        ...
                                                        <button class="btn btn-warning btn-sm rounded-circle p-2"
                                                            data-toggle="modal"
                                                            data-target="#editTimelineModal<?php echo e($item->id); ?>"
                                                            title="Edit">
                                                        ...
                                                        <button class="btn btn-danger btn-sm rounded-circle p-2"
                                                            data-toggle="modal"
                                                            data-target="#deleteTimelineModal<?php echo e($item->id); ?>"
                                                            title="Delete">
                                            ...
                                            <div class="modal fade" id="statusModal<?php echo e($item->id); ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('timeline.toggleStatus', $item->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="statusModalLabel<?php echo e($item->id); ?>">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Pilih status untuk timeline:
                                                                    <strong><?php echo e($item->judul_timline); ?></strong>.
                                                                </p>
                                                                <div class="form-group">
                                                                    <label>Status</label>
                                                                    <select name="status_timline" class="form-control">
                                                                        <option value="1"
                                                                            <?php echo e($item->status_timline == 1 ? 'selected' : ''); ?>>
                                                                            Aktif</option>
                                                                        <option value="2"
                                                                            <?php echo e($item->status_timline == 2 ? 'selected' : ''); ?>>
                                                                            Tidak Aktif</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                            ...
                                            <!-- Modal Edit -->
                                            <div class="modal fade" id="editTimelineModal<?php echo e($item->id); ?>"
                                                tabindex="-1" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('timeline.edit', $item->id)); ?>"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="judul_timline"
                                                                        class="form-control"
                                                                        value="<?php echo e($item->judul_timline); ?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Subjudul Timeline</label>
                                                                    <input type="text" name="subjudul_timline"
                                                                        class="form-control"
                                                                        value="<?php echo e($item->subjudul_timline); ?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Deskripsi</label>
                                                                    <textarea name="deskripsi_timeline" class="form-control"><?php echo e($item->deskripsi_timeline); ?></textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Sequence</label>
                                                                    <input type="number" name="sequence_timeline"
                                                                        class="form-control"
                                                                        value="<?php echo e($item->sequence_timeline); ?>">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="icons-container-edit" class="row">
                                                                        <?php $__currentLoopData = ['fa-home', 'fa-cog', 'fa-heart', 'fa-star', 'fa-book', 'fa-user', 'fa-flag', 'fa-rocket', 'fa-cloud', 'fa-check-circle', 'fa-envelope', 'fa-comment', 'fa-thumbs-up', 'fa-camera', 'fa-bell', 'fa-music', 'fa-paint-brush', 'fa-phone', 'fa-calendar', 'fa-laptop', 'fa-desktop', 'fa-sun', 'fa-moon', 'fa-snowflake', 'fa-shield-alt', 'fa-gift', 'fa-map', 'fa-users', 'fa-guitar', 'fa-puzzle-piece', 'fa-lightbulb']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <div class="col-3 mb-2">
                                                                                <i class="fa <?php echo e($icon); ?> icon-select-edit"
                                            ...
                                            <!-- Modal Delete -->
                                            <div class="modal fade" id="deleteTimelineModal<?php echo e($item->id); ?>"
                                                tabindex="-1" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('timeline.delete', $item->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="createTimelineModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('timeline.create')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div id="icons-container-create" class="row">
                                <?php $__currentLoopData = ['fa-home', 'fa-cog', 'fa-heart', 'fa-star', 'fa-book', 'fa-user', 'fa-flag', 'fa-rocket', 'fa-cloud', 'fa-check-circle', 'fa-envelope', 'fa-comment', 'fa-thumbs-up', 'fa-camera', 'fa-bell', 'fa-music', 'fa-paint-brush', 'fa-phone', 'fa-calendar', 'fa-laptop', 'fa-desktop', 'fa-sun', 'fa-moon', 'fa-snowflake', 'fa-shield-alt', 'fa-gift', 'fa-map', 'fa-users', 'fa-guitar', 'fa-puzzle-piece', 'fa-lightbulb']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-3 mb-2">
                                        <i class="fa <?php echo e($icon); ?> icon-select-create"
                                            style="font-size: 30px; cursor: pointer; color: #1363c6;"></i>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php echo $__env->make('AdminPage.App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\AdminPage\Timeline\index.blade.php ENDPATH**/ ?>