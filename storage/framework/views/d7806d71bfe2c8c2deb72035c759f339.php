                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <?php echo $__env->make('AdminPage.Berita.show', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadBerita(page = 1, search = '') {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let defaultImage = "<?php echo e(asset('assets_admin/img/noimage.jpg')); ?>";
            ...
            $('#createBeritaModal').on('shown.bs.modal', function() {
                ...
                const author = <?php echo json_encode(Auth::user()?->name, 15, 512) ?> || '';
...
<?php echo $__env->make('AdminPage.App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\AdminPage\Berita\index.blade.php ENDPATH**/ ?>