...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
            <h1 class="mb-4"><?php echo e($programMenu->judul); ?></h1>
            <p class="lead"><?php echo e($programMenu->subjudul); ?></p>
        </div>
            ...
            <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="program-card" id="program-card">
                    <img src="<?php echo e(asset('storage/' . $program->thumbnail_image)); ?>"
                         alt="<?php echo e($program->judul); ?>"
                         class="program-img">

                    <div class="card-body p-3 text-center d-flex flex-column">
                        <div>
                            <h5 class="card-title"><?php echo e($program->judul); ?></h5>
                            <p class="card-text text-muted mb-3">
                                <?php echo e(\Illuminate\Support\Str::limit(strip_tags($program->deskripsi), 60, '...')); ?>
                            ...
                            <div class="progress mt-2">
                                ...
                                <div class="progress-bar progress-bar-warning"
                                     style="width: <?php echo e(100 - $percent); ?>%;">
                                </div>
                            </div>

                            <p class="small mt-2"><?php echo e($done); ?> orang telah terdampak dari target <?php echo e($target); ?> penerima manfaat</p>
                        </div>

                        <!-- Tombol Aksi -->
                        <div class="action-buttons mt-3">
                            <button class="btn btn-primary open-modal"
                                    data-id="program-modal<?php echo e($program->id); ?>">
                                Lihat Detail
                            </button>
                            ...
                            <button type="button"
                                    ...
                                    data-program-image="<?php echo e(asset('storage/' . $program->thumbnail_image)); ?>">
...
<!-- Modal Program -->
<?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="program-modal<?php echo e($program->id); ?>" tabindex="-1"
        aria-labelledby="modalLabel<?php echo e($program->id); ?>" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel<?php echo e($program->id); ?>"><?php echo e($program->judul); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                   <div class="modal-body" style=" padding-bottom: 145px;">
                    <!-- Carousel Gambar Dokumentasi -->
                    <?php
                        $programImages = $program->foto_image ?: [];
                    ?>

                    <div id="carousel<?php echo e($program->id); ?>" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <?php $__empty_1 = true; $__currentLoopData = $programImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="carousel-item active">
                                    <img src="<?php echo e($program->thumbnail_image ? asset('storage/' . $program->thumbnail_image) : asset('assets/img/default.jpg')); ?>"
                                        class="d-block w-100" alt="Dokumentasi">
                                </div>
                            <?php endif; ?>
                        </div>
                        <button class="carousel-control-prev" type="button"
                            data-bs-target="#carousel<?php echo e($program->id); ?>" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        </button>
                        <button class="carousel-control-next" type="button"
                            data-bs-target="#carousel<?php echo e($program->id); ?>" data-bs-slide="next">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                        </button>
                    </div>

                <p class="mt-3"><?php echo html_entity_decode($program->deskripsi); ?></p>



                    <!-- Menampilkan Foto Mitra di Modal -->
                    <p class="mt-3">Mitra kami yang support di program <?php echo e($program->judul); ?></p>
                    <div class="d-flex justify-content-start mt-3 flex-wrap">
                        <?php $__currentLoopData = $program->mitras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mx-2 text-center">
                                <img src="<?php echo e(Storage::url($mitra->file)); ?>" alt="<?php echo e($mitra->nama_mitra); ?>"
                    ...
                    <!-- Progress Bars -->
                    <!--<label for="recipient-beneficiaries"><em>Penerima Manfaat <strong><?php echo e($program->judul); ?></strong>-->
                    <!--        berjumlah-->
                    <!--        <strong><?php echo e($program->program_yang_berhasil_dijalankan); ?></strong> orang </em></label>-->
                    <!--<div class="progress mt-2">-->
                    <!--    <div class="progress-bar progress-bar-primary" role="progressbar"-->
                    <!--        style="width: <?php echo e($program->jumlah_target_tercapai > 0 ? ($program->program_yang_berhasil_dijalankan / $program->jumlah_target_tercapai) * 100 : 0); ?>%;"-->
                    <!--        aria-valuenow="<?php echo e($program->program_yang_berhasil_dijalankan); ?>" aria-valuemin="0"-->
                    <!--        aria-valuemax="<?php echo e($program->jumlah_target_tercapai); ?>">-->
                    <!--    </div>-->
                    <!--</div>-->

                    <!--<label for="target"><em>Target yang Harus Dicapai-->
                    <!--        <strong><?php echo e($program->jumlah_target_tercapai); ?></strong>-->
                    <!--        orang</em></label>-->
                    <!--<div class="progress mt-2">-->
                    <!--    <div class="progress-bar progress-bar-warning" role="progressbar"-->
                    <!--        style="width: <?php echo e($program->jumlah_target_tercapai > 0 ? ($program->jumlah_target_tercapai / $program->jumlah_target_tercapai) * 100 : 0); ?>%;"-->
                    <!--        aria-valuenow="<?php echo e($program->jumlah_target_tercapai); ?>" aria-valuemin="0"-->
                    <!--        aria-valuemax="<?php echo e($program->jumlah_target_tercapai); ?>">-->
                    <!--    </div>-->
                    <!--</div>-->

                    <!-- Pencapaian Program -->
                    <label for="combined-target"><em>Pencapaian Program <strong><?php echo e($program->judul); ?>,</strong>
                            <strong><?php echo e($program->program_yang_berhasil_dijalankan); ?></strong> orang telah
                            menerima manfaaat dari target <strong><?php echo e($program->jumlah_target_tercapai); ?></strong> yang
                    ...
                    <div class="progress mt-2">
                        ...
                        <div class="progress-bar progress-bar-warning" role="progressbar"
                            style="width: <?php echo e($program->jumlah_target_tercapai > 0 ? (($program->jumlah_target_tercapai - $program->program_yang_berhasil_dijalankan) / $program->jumlah_target_tercapai) * 100 : 0); ?>%;"
                            aria-valuenow="<?php echo e($program->jumlah_target_tercapai - $program->program_yang_berhasil_dijalankan); ?>"
                            aria-valuemin="0" aria-valuemax="<?php echo e($program->jumlah_target_tercapai); ?>">
                        </div>
                    </div>
                    
                    
                    <?php if($program->feedbacks->isNotEmpty()): ?>
                    <h5 class="mt-4 d-flex align-items-center">
                        Dukungan Donatur
                        <span class="badge bg-primary ms-2">
                            <?php echo e($program->feedbacks_count ?? $program->feedbacks->count()); ?>

                        </span>
                    </h5>

                    <?php $__currentLoopData = $program->feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="feedback-card d-flex gap-3 mb-3 p-2 ps-3 border rounded-3 shadow-sm bg-light">
                            ...
                            <div>
                                <p class="mb-1 fw-semibold d-flex align-items-center flex-wrap">
                                    ...
                                    <?php if($fb->status_donasi == DonasiKilau::DONASI_AKTIVE): ?>
                                    ...
                                    <small class="text-muted ms-2">
                                        • <?php echo e($fb->created_at->diffForHumans(null,false,false,2)); ?>

                                    </small>
                                </p>

                                <p class="mb-0 text-muted"><?php echo e($fb->feedback); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>

                 <div id="program-modal-footer-<?php echo e($program->id); ?>"
                    ...
                    <!--    onclick="shareProgram('<?php echo e($program->judul); ?>', '<?php echo e($program->id); ?>')"-->
                   ...
                   <button type="button"
                            ...
                            onclick="shareProgram('<?php echo e($program->id); ?>')"
                            style="max-width: 600px; width: 100%;">
    ...
    <div class="modal-content border-0 shadow">
      ...
      <div class="modal-body text-center">
        ...
        <div class="d-flex justify-content-center gap-3 mt-3">
            ...
            <a href="<?php echo e(url('/register')); ?>" class="btn btn-outline-secondary">Registrasi</a>
        </div>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('LandingPageKilau.Components.donasi-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<script>
    document.addEventListener('DOMContentLoaded', function () {
        const isAuthenticated = <?php echo json_encode(Auth::check(), 15, 512) ?>;
        const affiliateSub = <?php echo json_encode(session('user_id'), 15, 512) ?>;

        document.querySelectorAll('.btn-referral-share').forEach(function (btn) {
            const programId = btn.dataset.programId;

            btn.addEventListener('click', function () {
                if (!isAuthenticated || !affiliateSub) {
                    const authModal = new bootstrap.Modal(document.getElementById('authReferralModal'));
                    authModal.show();
                } else {
                    const referralUrl = `<?php echo e(url('/program')); ?>/${programId}/referral/${encodeURIComponent(affiliateSub)}`;

                    if (window.trackKilauEvent) {
                        window.trackKilauEvent('click_referral_program', {
                            source: 'referral_link',
                            link_url: referralUrl
                        });
                    }
        ...
        <?php if(session('scrollToProgram')): ?>
            setTimeout(() => {
                const el = document.getElementById('program-modal<?php echo e(session('scrollToProgram')); ?>');
...
<?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\ourprogram.blade.php ENDPATH**/ ?>