...
<?php $__env->startSection('content'); ?>
                                ...
                                <table id="struktur-table" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $struktur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($item->name_judul); ?></td>
                                                <td>
                                                    <?php if($item->file): ?>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge <?php echo e($item->status_struktur === 'Aktif' ? 'badge-success' : 'badge-danger'); ?>">
                                                        <?php echo e($item->status_struktur); ?>
                                            ...
                                            <div class="modal fade" id="editStrukturModal<?php echo e($item->id); ?>"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('profil.strukturEdit', $item->id)); ?>"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="name_judul"
                                                                        class="form-control"
                                                                        value="<?php echo e($item->name_judul); ?>" required>
                                                                </div>
                                                                <div class="form-group">
                                            ...
                                            <div class="modal fade" id="statusModal<?php echo e($item->id); ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form
                                                            action="<?php echo e(route('profil.strukturToggleStatus', $item->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="status_struktur" class="form-control"
                                                                        required>
                                                                        <option value="1"
                                                                            <?php echo e($item->status_struktur == 1 ? 'selected' : ''); ?>>
                                                                            Aktif</option>
                                                                        <option value="2"
                                                                            <?php echo e($item->status_struktur == 2 ? 'selected' : ''); ?>>
                                                                            Tidak Aktif</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="modal fade" id="deleteStrukturModal<?php echo e($item->id); ?>"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('profil.strukturDelete', $item->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="createStrukturModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('profil.strukturCreate')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
...
<?php echo $__env->make('AdminPage.App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\AdminPage\Profile\Struktur\index.blade.php ENDPATH**/ ?>