    ...
    <div class="container-fluid py-5 blog-section">
        <div class="container py-5">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    <section id="blog-details" class="blog-details section">
                        <article class="article">
                            ...
                            <?php if(isset($berita['foto']) || isset($berita['foto2']) || isset($berita['foto3'])): ?>
                                <div class="post-img">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                        <!-- Indikator -->
                                        <div class="carousel-indicators">
                                            <?php if(isset($berita['foto'])): ?>
                                                <button type="button" data-bs-target="#carouselExampleIndicators"
                                                    data-bs-slide-to="0" class="active"></button>
                                            <?php endif; ?>
                                            <?php if(isset($berita['foto2'])): ?>
                                                <button type="button" data-bs-target="#carouselExampleIndicators"
                                                    data-bs-slide-to="1"></button>
                                            <?php endif; ?>
                                            <?php if(isset($berita['foto3'])): ?>
                                                <button type="button" data-bs-target="#carouselExampleIndicators"
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <?php if(isset($berita['foto'])): ?>
                                                <div class="carousel-item <?php echo e($active); ?>">
                                                    <img src="https://berbagipendidikan.org<?php echo e($berita['foto']); ?>"
                                                        class="d-block w-100">
                                                </div>
                                                <?php $active = ''; ?>
                                            <?php endif; ?>
                                            <?php if(isset($berita['foto2'])): ?>
                                                <div class="carousel-item <?php echo e($active); ?>">
                                                    <img src="https://berbagipendidikan.org<?php echo e($berita['foto2']); ?>"
                                                        class="d-block w-100">
                                                </div>
                                                <?php $active = ''; ?>
                                            <?php endif; ?>
                                            <?php if(isset($berita['foto3'])): ?>
                                                <div class="carousel-item <?php echo e($active); ?>">
                                                    <img src="https://berbagipendidikan.org<?php echo e($berita['foto3']); ?>"
                                                        class="d-block w-100">
                                                </div>
                                            <?php endif; ?>
                                        </div>
                            ...
                            <h2 class="title"><?php echo e($berita['judul'] ?? 'Null'); ?></h2>
                            ...
                            <?php if(!empty($berita['author'])): ?>
                                <div class="d-flex align-items-center mt-1">
                                    ...
                                    <span class="text-muted">
                                        <strong>Penulis&nbsp;:</strong> <?php echo e($berita['author']); ?>
                            ...
                            <div class="meta-top">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <time><?php echo e(\Carbon\Carbon::parse($berita['tanggal'] ?? 'now')->translatedFormat('d F Y H:i')); ?>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-bold"><?php echo e(number_format($berita['views_berita'] ?? 0)); ?></span>
                                ...
                                <div class="meta-right">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <i class="far fa-thumbs-up like-button text-secondary"
                                            data-id="<?php echo e($berita['id']); ?>"></i>
                                        <span class="like-count"><?php echo e($berita['likes_berita'] ?? 0); ?></span>
                                    </div>
                            ...
                            <div id="modal-tags" class="tags-container">
                                <?php if(isset($berita['tags']) && count($berita['tags']) > 0): ?>
                                    <?php $__currentLoopData = $berita['tags']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e($tag['link']); ?>" target="_blank" class="tag-link"><?php echo e($tag['nama']); ?></a>
                ...
                <?php echo $__env->make('LandingPageKilau.Berita.komentar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <?php echo $__env->make('LandingPageKilau.Berita.partials-donasi', ['programs' => $programs], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        $(document).ready(function() {
            ...
            let beritaId = "<?php echo e($berita['id']); ?>";
...
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\Berita\berita.blade.php ENDPATH**/ ?>