            ...
            <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3 col-md-6">
                    <div class="card program-card">
                        <img src="<?php echo e(asset('storage/' . $program->thumbnail_image)); ?>" class="card-img-top program-img"
                            alt="<?php echo e($program->judul); ?>">

                        <div class="card-body text-center d-flex flex-column">
                            <h5 class="card-title"><?php echo e($program->judul); ?></h5>
                            <p class="card-text text-muted">
                                <?php echo e(\Illuminate\Support\Str::limit(str_replace('&nbsp;', ' ', html_entity_decode(strip_tags($program->deskripsi))), 30, '...')); ?>
                            ...
                            <p class="small mt-2"><?php echo e($program->program_yang_berhasil_dijalankan); ?> orang telah
                                terdampak dari target <?php echo e($program->jumlah_target_tercapai); ?> penerima manfaat</p>
                   ...
                   <div class="modal-body" style=" padding-bottom: 145px;">
                    ...
                    <div id="carousel<?php echo e($program->id); ?>" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <?php $__currentLoopData = $program->foto_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\testprogram.blade.php ENDPATH**/ ?>