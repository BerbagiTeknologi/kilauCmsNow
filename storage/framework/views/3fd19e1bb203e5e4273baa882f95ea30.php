                ...
                <div class="row g-3">
                    <div class="col-6 col-md">
                        <div class="p-3 border rounded-3 bg-light">
                            ...
                            <div class="fs-5 fw-semibold"><?php echo e($historySummary['total_transaksi']); ?></div>
                        </div>
                    </div>
                    <div class="col-6 col-md">
                        <div class="p-3 border rounded-3 bg-light">
                            <div class="small text-muted">Total Nominal</div>
                            <div class="fs-5 fw-semibold">Rp <?php echo e(number_format($historySummary['total_nominal'], 0, ',', '.')); ?></div>
                        </div>
                    </div>
                    <div class="col-6 col-md">
                        <div class="p-3 border rounded-3 bg-light">
                            <div class="small text-muted">Aktif</div>
                            <div class="fs-5 fw-semibold text-success"><?php echo e($historySummary['jumlah_aktif']); ?></div>
                        </div>
                    </div>
                    <div class="col-6 col-md">
                        <div class="p-3 border rounded-3 bg-light">
                            <div class="small text-muted">Pending</div>
                            <div class="fs-5 fw-semibold text-warning"><?php echo e($historySummary['jumlah_pending']); ?></div>
                        </div>
                    </div>
                    <div class="col-6 col-md">
                        <div class="p-3 border rounded-3 bg-light">
                            <div class="small text-muted">Expired</div>
                            <div class="fs-5 fw-semibold text-secondary"><?php echo e($historySummary['jumlah_expired']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <?php if($histories->total() > 0): ?>
                    <div class="donation-pagination p-3 d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
                        <small class="text-muted">
                            Menampilkan <?php echo e($histories->firstItem()); ?>-<?php echo e($histories->lastItem()); ?>

                            dari <?php echo e($histories->total()); ?> transaksi
                        </small>

                        <?php if($histories->hasPages()): ?>
                            <?php echo e($histories->onEachSide(1)->links('pagination::bootstrap-5')); ?>
