...
<?php $__env->startSection('content'); ?>
                ...
                <div class="modal-body p-0 position-relative"> 
                    ...
                    <div id="carouselIklan" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <?php $__currentLoopData = $donasiiklan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="carousel-item <?php echo e($index == 0 ? 'active' : ''); ?>">
                                   <img src="<?php echo e(Storage::url($item->file)); ?>" class="d-block w-100 img-fluid" alt="Iklan Donasi">
                                </div>
               ...
               <div class="modal-footer border-0">
                    <button type="button" class="btn btn-primary w-100 d-flex align-items-center justify-content-center gap-2" 
                        ...
                        <span style="position: relative; display: inline-block; width: 1.5em; height: 1.3em;">
                            <i class="fas <?php echo e($ikon); ?>" style="color: white; font-size: 1.2em;"></i>
                        </span>
                        <?php echo e($label); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="donasiForm" method="POST">
                        ...
                        <!--                <div class="card program-card" data-program="<?php echo e($program->judul); ?>"-->
                        <!--                    data-program-id="<?php echo e($program->id); ?>">-->
                        <!--                    <img src="<?php echo e(asset('storage/' . $program->foto_image[0])); ?>"-->
                        <!--                        class="card-img-top" alt="Image">-->
                        <!--                    <div class="card-body">-->
                        <!--                        <h5 class="card-title" title="<?php echo e($program->judul); ?>">-->
                        <!--                            <?php echo e(Str::limit($program->judul, 20)); ?>-->
                        <!--                        </h5>-->
                        <!--                    </div>-->
                        <!--                </div>-->
                        <!--            </div>-->
                       ...
                       <div class="mb-3" id="program-cards" style="display: none;">
                            ...
                            <div class="row row-cols-2 row-cols-md-4 g-3"> <!-- Bootstrap Grid -->
                                <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col">
                                        <div class="card program-card h-100" data-program="<?php echo e($program->judul); ?>" data-program-id="<?php echo e($program->id); ?>">
                                            <img src="<?php echo e(asset('storage/' . $program->thumbnail_image)); ?>" class="card-img-top program-img img-fluid" alt="<?php echo e($program->judul); ?>">
                                        ...
                                        <?php if($embedURL): ?>
                                            <div class="card-img-top">
                                                <iframe class="embed-responsive-item w-100" height="300"
                                                    src="<?php echo e($embedURL); ?>" title="YouTube video player"
                                                    frameborder="0"
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="ms-3" style="flex-grow: 1; overflow: hidden;">
                                                <h5 class="mb-1"
                                                    ...
                                                    <?php echo e($testimoni->nama); ?></h5>
                                                <span><?php echo e($testimoni->pekerjaan); ?></span>
                                            </div>
                                        </div>

                                        <!-- If there's a comment, display it, else let the video occupy the space -->
                                        <div class="flex-grow-1">
                                            <?php if($testimoni->komentar): ?>
                                                <p class="card-text fs-6 mb-3"><?php echo e(strip_tags($testimoni->komentar)); ?></p>
                                            <?php else: ?>
    ...
    <!--                                            <img class="img-fluid rounded-circle"-->
    <!--                                                src="<?php echo e($testimoni->file ? Storage::url($testimoni->file) : asset('images/default.png')); ?>"-->
    <!--                                                style="width: 60px; height: 60px;" />-->
    <!--                                            <div class="ms-3">-->
    <!--                                                <h5 class="mb-1" style="text-align: left;"><?php echo e($testimoni->nama); ?>-->
    <!--                                                </h5>-->
    <!--                                                <span style="text-align: left;"><?php echo e($testimoni->pekerjaan); ?></span>-->
    <!--                                            </div>-->
    <!--                                        </div>-->

    <!--                                        <div>-->
    <!--                                            <p class="fs-4">-->
    <!--                                                <?php echo e(strip_tags($testimoni->komentar)); ?>-->
    <!--                                            </p>-->
    <!--                                        </div>-->
    <!--                                    </div>-->
    ...
    <!--                    <?php $__currentLoopData = $mitras->slice(0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
    ...
    <!--                                class="img-fluid w-100" style="max-width: 200px;" alt="<?php echo e($mitra->nama_mitra); ?>">-->
    <!--                        </div>-->
    <!--                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
    <!--                <?php else: ?>-->
    ...
    <!--                <?php if($mitras && $mitras->count() > 4): ?>-->
    <!--                    <?php $__currentLoopData = $mitras->slice(5, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
                ...
                <?php if($mitras && $mitras->count()): ?>
                    <?php $__currentLoopData = $mitras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-1 col-md-2 col-3 mb-4 text-center">
                            <img src="<?php echo e($mitra->file ? Storage::url($mitra->file) : asset('images/default.png')); ?> "
                                class="img-fluid w-110" style="max-width: 110px;" alt="<?php echo e($mitra->nama_mitra); ?>">
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                    <p class="text-center">Belum ada mitra donatur yang aktif.</p>
...
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\indexke2.blade.php ENDPATH**/ ?>