                ...
                <li class="nav-item dropdown me-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end animated fadeIn shadow-sm"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $notifList ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="px-3 py-2 small <?php echo e($n->status === 'unread' ? 'fw-bold' : ''); ?>">
                                <?php echo e($n->message); ?><br>
                                <span class="text-muted fst-italic">
                                    <?php echo e($n->created_at->diffForHumans()); ?>

                                </span>
                            </li>
                            <?php if(!$loop->last): ?><li><hr class="dropdown-divider my-0"></li><?php endif; ?>
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item text-center small" href="<?php echo e(route('article')); ?>">
                                Lihat semua
                            </a>
                        </li>
                    </ul>
...
<?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views/AdminPage/App/navbar.blade.php ENDPATH**/ ?>