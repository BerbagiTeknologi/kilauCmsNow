...
<head>
    ...
    <?php if($googleAnalyticsMeasurementId): ?>
        <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo e($googleAnalyticsMeasurementId); ?>"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag() { dataLayer.push(arguments); }
            gtag('js', new Date());
            gtag('config', '<?php echo e($googleAnalyticsMeasurementId); ?>');
        </script>
    <?php endif; ?>
    <script>
    ...
    <?php if(isset($berita) && !empty($berita)): ?>
        ...
        <meta property="og:title" content="<?php echo e($berita['judul'] ?? 'Default Title'); ?>" />
        <meta property="og:description" content="<?php echo e(isset($berita['konten']) ? strip_tags($berita['konten']) : 'Deskripsi tidak tersedia'); ?>" />
        <meta property="og:image" content="<?php echo e(isset($berita['foto']) ? 'https://berbagipendidikan.org' . $berita['foto'] : asset('storage/default.jpg')); ?>" />
        <meta property="og:url" content="<?php echo e(url()->current()); ?>" />
    <?php elseif(isset($selectedProgram) && !empty($selectedProgram)): ?>
        <!-- Jika sedang di halaman program -->
        <meta property="og:title" content="<?php echo e($selectedProgram->judul ?? 'Default Title'); ?>" />
        <meta property="og:description" content="<?php echo e($selectedProgram ? strip_tags($selectedProgram->deskripsi) : 'Default Description'); ?>" />
        <meta property="og:image" content="<?php echo e(asset('storage/' . ($selectedProgram->thumbnail_image ?? 'default.jpg'))); ?>" />
        <meta property="og:url" content="<?php echo e(url()->current()); ?>" />
    <?php else: ?>
...
<body>
    ...
    <div class="floating-buttons">
           <a href="#" class="donation-button" id="floating-donate-btn" title="Donasi"
                ...
                <?php if(isset($selectedProgram)): ?> data-program-id="<?php echo e($selectedProgram->id); ?>" <?php endif; ?>>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const HOME_BASE  = "<?php echo e(url('/')); ?>";
...
<?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views/App/master.blade.php ENDPATH**/ ?>