                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <?php echo $__env->make('AdminPage.Artikel.show', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        const currentUser = <?php echo json_encode([
            'name' => Auth::user()?->name, 'photo' => session('user_photo'), ]) ?>;
        const katURL = "<?php echo e(url('admin/article-kilau/kategori-article/list')); ?>";

        $('#createArticleModal').on('shown.bs.modal', () => {
            const author = currentUser.name || '';
            const raw = currentUser.photo || '';
        ...
        function uploadImage(q) {
            ...
            input.onchange = () => {
                ...
                fetch("<?php echo e(url('admin/upload-image-article')); ?>", {
                        method: 'POST',
                        headers: {
        ...
        $('#create-article-form').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/article-kilau/article/create')); ?>",
                type: 'POST',
                data: fd,
                processData: false,
                contentType: false,
    ...
    <script>
        ...
        $(function() {
            ...
            $(document).on('click', '.edit-article', function() {
                ...
                $.get("<?php echo e(url('admin/article-kilau/article/show')); ?>/" + currentArticleId)
                    .done(res => {
                        ...
                        const rawPhotoAuthor = res.photo_author || currentUser.photo ||
                            '';
            ...
            $(document).on('click', '.remove-photo', function() {
                ...
                if (type === 'old') {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('admin/article-kilau/article/photo')); ?>/" + currentArticleId,
                        type: 'DELETE',
                        data: {
                            path
                        },
        ...
        `;
            ...
            $('#edit-article-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/article-kilau/article/update')); ?>/" + currentArticleId,
                    type: 'POST',
                    data: fd,
                    processData: false,
                    contentType: false,
    ...
    <script>
        $(function() {
            ...
            const baseToggleUrl = "<?php echo e(url('admin/article-kilau/article/status')); ?>";
            const baseFeedbackUrl = "<?php echo e(url('admin/article-kilau/article')); ?>"; // /{id}/feedback
            ...
            $(document).on('click', '.delete-article', function() {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        url: "<?php echo e(route('deleteArticle')); ?>",
                        type: 'DELETE',
                        data: {
                            id
                        },
            ...
            function fetchArticles(page = 1, search = '') {
                $.get("<?php echo e(route('article.list')); ?>", {
                    search
                }, function(data) {
                    allData = data;
                    currentPage = page;
            ...
            function renderTable(data, startIndex) {
                let html = '';
                let no = startIndex + 1;
                const defaultImg = "<?php echo e(asset('assets_admin/img/noimage.jpg')); ?>";
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.show-article', function() {
                const id = $(this).data('id');
                const url = "<?php echo e(url('admin/article-kilau/article/show')); ?>/" + id;
                    ...
                    .done(res => {
                        ...
                        const images = res.photos.length ?
                            res.photos.map(p => p.url) : [
                                '<?php echo e(asset('assets_admin/img/noimage.jpg')); ?>'
                            ];
...
<?php echo $__env->make('AdminPage.App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\AdminPage\Artikel\index.blade.php ENDPATH**/ ?>