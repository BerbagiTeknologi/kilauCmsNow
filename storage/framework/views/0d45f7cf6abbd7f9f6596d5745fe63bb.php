...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $mitras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($mitra->nama_mitra); ?></td>
                                                <td>
                                                    <?php if($mitra->file): ?>
                                                        <img src="<?php echo e(Storage::url($mitra->file)); ?>" alt="Mitra Logo"
                                                ...
                                                <td>
                                                    <span
                                                        class="badge <?php echo e($mitra->status_mitra === 'Aktif' ? 'badge-success' : 'badge-danger'); ?>">
                                                        <?php echo e($mitra->status_mitra); ?>
                                                ...
                                                <td>
                                                    <div class="btn-group gap-2" role="group">
                                                        ...
                                                        <button class="btn btn-warning btn-sm rounded-circle p-2"
                                                            data-toggle="modal"
                                                            data-target="#editMitraModal<?php echo e($mitra->id); ?>" title="Edit">
                                                        ...
                                                        <button class="btn btn-danger btn-sm rounded-circle p-2"
                                                            data-toggle="modal"
                                                            data-target="#deleteMitraModal<?php echo e($mitra->id); ?>"
                                                            title="Delete">
                                                        ...
                                                        <button class="btn btn-info btn-sm rounded-circle p-2"
                                                            data-toggle="modal"
                                                            data-target="#statusModal<?php echo e($mitra->id); ?>"
                                                            title="Ubah Status">
                                            ...
                                            <!-- Modal Toggle Status -->
                                            <div class="modal fade" id="statusModal<?php echo e($mitra->id); ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="statusModalLabel<?php echo e($mitra->id); ?>"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('mitra.toggleStatus', $mitra->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="statusModalLabel<?php echo e($mitra->id); ?>">
                                                                    Ubah Status Mitra
                                                                </h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Pilih status untuk Mitra:
                                                                    <strong><?php echo e($mitra->nama_mitra); ?></strong>.
                                                                </p>
                                                                <div class="form-group">
                                                                    <label>Status</label>
                                                                    <select name="status_mitra" class="form-control">
                                                                        <option value="1"
                                                                            <?php echo e($mitra->status_mitra == 1 ? 'selected' : ''); ?>>
                                                                            Aktif</option>
                                                                        <option value="2"
                                                                            <?php echo e($mitra->status_mitra == 2 ? 'selected' : ''); ?>>
                                                                            Tidak Aktif</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                            ...
                                            <!-- Modal Edit -->
                                            <div class="modal fade" id="editMitraModal<?php echo e($mitra->id); ?>" tabindex="-1"
                                                role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('mitra.edit', $mitra->id)); ?>" method="POST"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="nama_mitra"
                                                                        class="form-control"
                                                                        value="<?php echo e($mitra->nama_mitra); ?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Logo Mitra</label>
                                                                    <input type="file" name="file"
                                                                        class="form-control file-input"
                                                                        data-preview="#editImagePreview<?php echo e($mitra->id); ?>">
                                                                    <small class="text-muted">Hanya gambar dengan format
                                                                        jpeg, png, jpg, gif, svg yang diterima.</small>
                                                                    <div class="mt-2">
                                                                        <img id="editImagePreview<?php echo e($mitra->id); ?>"
                                                                            src="<?php echo e(Storage::url($mitra->file)); ?>"
                                            ...
                                            <!-- Modal Delete -->
                                            <div class="modal fade" id="deleteMitraModal<?php echo e($mitra->id); ?>"
                                                tabindex="-1" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('mitra.delete', $mitra->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Apakah Anda yakin ingin menghapus mitra
                                                                    <strong><?php echo e($mitra->nama_mitra); ?></strong>?</p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-dismiss="modal">Close</button>
    ...
    <div class="modal fade" id="createMitraModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('mitra.create')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
...
<?php echo $__env->make('AdminPage.App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\AdminPage\MitraDonatur\index.blade.php ENDPATH**/ ?>