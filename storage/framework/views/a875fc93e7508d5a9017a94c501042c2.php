                ...
                <div class="col-12 text-center" style="margin-top: 100px !important;">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center mb-0">
                            <li class="breadcrumb-item"><a class="text-white" href="<?php echo e(route('home')); ?>">Beranda</a></li>
    ...
    <div class="container-fluid py-5 contact-section">
        <div class="container py-5">
            ...
            <div class="form-container mt-4 p-4 border rounded">
                ...
                <form action="<?php echo e(route('contact.create')); ?>" method="POST" enctype="multipart/form-data"
                    data-ga-submit-event="submit_contact_form" data-ga-form-name="contact_collaboration"
                    data-ga-include="id_program,kategori_mitra,jenis_kerjasama">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-4 mb-3">
                                    <input type="radio" id="program_<?php echo e($program->id); ?>" name="id_program"
                                        value="<?php echo e($program->id); ?>" class="btn-check program-radio" required
                                        data-judul="<?php echo e($program->judul); ?>" data-ga-change-event="select_contact_program"
                                        data-ga-program-id="<?php echo e($program->id); ?>" data-ga-program-title="<?php echo e($program->judul); ?>">
                                    <label for="program_<?php echo e($program->id); ?>" class="btn btn-outline-primary w-100 py-2">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            ?>
                            <?php $__currentLoopData = $kategoriMitra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-4 mb-2">
                                    <input type="radio" id="kategori_<?php echo e($index); ?>" name="kategori_mitra"
                                        value="<?php echo e($kategori); ?>" class="btn-check kategori-mitra-radio" required
                                        data-ga-change-event="select_contact_partner_category"
                                        data-ga-partner-category="<?php echo e($kategori); ?>">
                                    <label for="kategori_<?php echo e($index); ?>" class="btn btn-outline-primary w-100 py-2">
                                        <?php echo e($kategori); ?>
            ...
            <div class="row g-5 py-5">
                <div class="col-12 text-section wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-3"><?php echo e($kontakMenu->judul); ?></h1>
                    <p class="mb-3"><?php echo e($kontakMenu->subjudul); ?></p>
                </div>
            </div>

            <!-- Daftar Kantor Cabang -->
            <div class="row g-5">
                <?php if(count($kontaks) > 0): ?>
                    <?php $__currentLoopData = $kontaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kontak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-6">
                            <div class="contact-info">
                                <h3><?php echo e($kontak->nama_kacab); ?></h3>
                                <p><i class="fas fa-map-marker-alt"></i> <?php echo e($kontak->alamat); ?></p>
                                <p><i class="fas fa-phone"></i> <?php echo e($kontak->telephone); ?></p>
                                <p><i class="fas fa-envelope"></i> <?php echo e($kontak->email); ?></p>
                                <div class="map-container">
                                    <div id="map-preview<?php echo e($kontak->id); ?>" style="width: 100%; height: 300px;"></div>
                                    <input type="hidden" name="maplink" id="maplink<?php echo e($kontak->id); ?>"
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('services.google_maps.api_key')); ?>&region=ID&language=id&libraries=places&callback=initAllMaps">
    </script>
    ...
    <script>
                ...
                radio.addEventListener("change", function() {
                    ...
                    if (jenisKerjasamaMapping[selectedProgramJudul]) {
                        jenisKerjasamaMapping[selectedProgramJudul].forEach((jenis, index) => {
                            ...
                            inputRadio.dataset.gaChangeEvent = "select_contact_cooperation_type";
                            inputRadio.dataset.gaCooperationType = jenis;
        ...
        function initAllMaps() {
            ...
            <?php if(count($kontaks) > 0): ?>
                <?php $__currentLoopData = $kontaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kontak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    initMap('map-preview<?php echo e($kontak->id); ?>', '<?php echo e($kontak->maplink); ?>');
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
        }
    </script>
...
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\kontak.blade.php ENDPATH**/ ?>