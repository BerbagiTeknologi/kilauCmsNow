<div class="komentar-section mt-5">
    ...
    <div class="form-komentar mb-4">
        ...
        <form id="form-komentar">
            <input type="hidden" name="id_berita" value="<?php echo e($berita['id']); ?>">
...
$(document).ready(function() {
    ...
    const beritaId = <?php echo json_encode($berita['id'] ?? null, 15, 512) ?>;
    const judulBerita = "<?php echo e($berita['judul']); ?>";
    ...
    function renderKomentar(komentar, indent = 0) {
        let html = '';
        komentar.forEach(k => {
            let nama = k.nama_pengirim ? k.nama_pengirim : (userName || "Anonymous");
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\Berita\komentar.blade.php ENDPATH**/ ?>