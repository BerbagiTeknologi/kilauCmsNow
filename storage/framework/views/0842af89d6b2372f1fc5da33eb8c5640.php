                ...
                <div class="col-lg-8">
                    <section id="blog-details" class="blog-details section">
                        <article class="article">
                            ...
                            <div class="meta-top">
                                ...
                                <div class="meta-right">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span id="like-count"><?php echo e($berita['likes_berita'] ?? 0); ?></span>
                                    </div>
                            ...
                            <?php if(isset($berita['kategori']) && isset($berita['kategori']['name_kategori'])): ?>
                                <div class="d-flex align-items-center mb-2">
                                    <i class="fas fa-folder-open text-primary me-2"></i>
                                    <a href="/berita?kategori=<?php echo e($berita['kategori']['id']); ?>"
                                        class="badge bg-primary text-white px-3 py-2 text-decoration-none">
                                        <?php echo e($berita['kategori']['name_kategori']); ?>
...
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\Berita\Cadangan\berita2.blade.php ENDPATH**/ ?>