...
$(function () {
    ...
    const PLACEHOLDER = '<?php echo e(asset('assets_admin/img/noimage.jpg')); ?>';
    ...
    function fetchPage(p = 1) {
        $.get("<?php echo e(route('lp.article.list')); ?>", { page: p }, res => {
              ...
              <div class="card shadow-sm card-article">
                ...
                <div class="card-body">
                  ...
                  <h6 class="fw-bold mb-1">
                    ...
                    <a href="<?php echo e(url('artikel')); ?>/${a.slug}" class="text-decoration-none text-dark"
                       data-ga-event="open_article" data-ga-article-slug="${a.slug}" data-ga-source="article_index">
                      ${a.title}
                    </a>
                  </h6>
...
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\Article\index.blade.php ENDPATH**/ ?>