        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-12 text-section wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-4"><?php echo e($strukturMenu->judul); ?></h1>
                    <p class="struktur-description mb-4">
                        <?php echo e($strukturMenu->subjudul); ?>

                    </p>
                    <p class="struktur-description mb-4">
                        <?php echo e($strukturs->first() ? $strukturs->first()->name_judul : 'Struktur tidak tersedia'); ?>
                ...
                <div class="col-12 image-section wow fadeIn" data-wow-delay="0.3s">
                    <div class="image-wrapper">
                        ...
                        <?php if($strukturs->isNotEmpty() && $strukturs->first()->file): ?>
                            <img class="struktur-img img-fluid" src="<?php echo e(Storage::url($strukturs->first()->file)); ?>" alt="Struktur Organisasi">
                        <?php else: ?>
...
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\Profile\profilStruktur.blade.php ENDPATH**/ ?>