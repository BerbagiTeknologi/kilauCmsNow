                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="referral-table" class="display table table-striped table-hover">
                               ...
                               <tbody>
                                    <?php $__currentLoopData = $referrals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($ref->program->judul ?? '-'); ?></td>
                                            <td><?php echo e($ref->referer_name); ?></td>
                                            <td><strong><?php echo e($ref->click_count); ?></strong></td>
                                            <td><span class="badge-total">Rp <?php echo e(number_format($uang, 0, ',', '.')); ?></span></td>
                                            <td><?php echo e(\Carbon\Carbon::parse($ref->created_at)->format('d M Y H:i')); ?></td>
                                            <td>
                                                <div class="btn-group gap-2" role="group">
                                                    <button class="btn btn-primary btn-sm rounded-circle p-2 show-referral"
                                                        data-id="<?php echo e($ref->id); ?>"
                                                        data-judul="<?php echo e($ref->program->judul); ?>"
                                                        data-referer="<?php echo e($ref->referer_name); ?>"
                                                        data-click="<?php echo e($ref->click_count); ?>"
                                                        data-total="<?php echo e($uang); ?>"
                                                        data-withdrawals='<?php echo json_encode($withdrawals, 15, 512) ?>'
    ...
    $(document).ready(function () {
        ...
        $('.show-referral').on('click', function () {
            ...
            if (withdrawals.length > 0) {
                ...
                if (pending) {
                    const approveUrl = `<?php echo e(route('programReferrals.approve', ':id')); ?>`.replace(':id', pending.id);
                    const rejectUrl = `<?php echo e(route('programReferrals.reject', ':id')); ?>`.replace(':id', pending.id);
...
<?php echo $__env->make('AdminPage.App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\AdminPage\Program\ProgramReferral\index.blade.php ENDPATH**/ ?>