...
<div class="modal fade" id="createBeritaModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg"><div class="modal-content">
    <form id="create-berita-form" enctype="multipart/form-data"><?php echo csrf_field(); ?>
...
const currentUserName = <?php echo json_encode(Auth::user()?->name, 15, 512) ?>;
let   page     = 1;
const perPage  = 6;
...
function loadBerita(p=1,q=''){
  ...
  $.get(`${API}/api/berita`,{page:p,per_page:perPage,search:q})
   .done(r=>{
      const list=r.data||[]; const base=API; const noImg="<?php echo e(asset('assets_admin/img/noimage.jpg')); ?>";
...
$('#create-berita-form').on('submit',function(e){
  e.preventDefault();
  if(!isAuthenticated) return Swal.fire("Harus login","", "warning");
...
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\Components\berita-users.blade.php ENDPATH**/ ?>