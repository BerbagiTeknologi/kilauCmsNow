    ...
    <div class="container py-5">
        ...
        <div class="container py-1 text-center">
            ...
            <select id="filterCabang" class="form-select w-auto d-inline-block">
                ...
                <?php $__currentLoopData = $galeri->unique('nama_kantor_cabang'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cabang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($cabang->nama_kantor_cabang); ?>"><?php echo e($cabang->nama_kantor_cabang); ?></option>
        ...
        <div class="gallery-container py-4" id="gallery">
            <?php echo $__env->make('LandingPageKilau.galeri-items', ['galeri' => $galeri], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\galeri.blade.php ENDPATH**/ ?>