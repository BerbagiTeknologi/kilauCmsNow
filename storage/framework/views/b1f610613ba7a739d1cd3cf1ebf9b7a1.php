...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><strong><em><?php echo e($item->program_yang_berhasil_dijalankan); ?></em></strong>
                                                    orang telah terdampak</td>
                                                <td><strong><em><?php echo e($item->jumlah_target_tercapai); ?></em></strong> orang yang
                                                    ingin dicapai</td>
                                                <!--<td><?php echo e($item->deskripsi); ?></td>-->
                                              <td>
                                                    <?php echo e(Str::limit(str_replace('&nbsp;', ' ', strip_tags($item->deskripsi)), 300, '...')); ?>

                                                </td>

                                                <td>
                                                    <span
                                                        class="badge <?php echo e($item->status_program == 'Aktif' ? 'badge-success' : 'badge-danger'); ?>">
                                                        <?php echo e($item->status_program); ?>

                                                    </span>
                                                </td>
                                                <td>
                                                    <?php if($item->foto_image): ?>
                                                        <div class="form-group">
                                                            <div>
                                                                <?php $__currentLoopData = $item->foto_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <td>
                                                    <?php if($item->thumbnail_image): ?>
                                                        <img src="<?php echo e(Storage::url($item->thumbnail_image)); ?>"
                                                ...
                                                <td style="white-space: nowrap;">
                                                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 5px;">
                                                        <?php $__currentLoopData = $item->mitras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <!-- Menampilkan foto mitra yang terkait -->
                                                            <div style="width: 100px; height: auto;">
                                                                <?php if($mitra->file): ?>
                                                                    <!-- Pastikan mitra memiliki file gambar -->
                                                                    <img src="<?php echo e(Storage::url($mitra->file)); ?>" alt="<?php echo e($mitra->nama_mitra); ?>" width="100" height="auto">
                                                                <?php else: ?>
                                                                    No Image
                                                                <?php endif; ?>
                                                            </div>
                                                ...
                                                <td>
                                                    <div class="btn-group gap-2" role="group">
                                                        ...
                                                        <button
                                                            ...
                                                            data-presentase="<?php echo e($item->program_yang_berhasil_dijalankan); ?>"
                                                            data-jumlah_target_tercapai="<?php echo e($item->jumlah_target_tercapai); ?>"
                                                            data-thumbnail="<?php echo e(Storage::url($item->thumbnail_image)); ?>"
                                                            data-file_galeri="<?php echo e(json_encode($item->foto_image)); ?>"
                                                            data-mitra_ids="<?php echo e(json_encode($item->mitras->pluck('id')->toArray())); ?>"
                                                            title="Edit">
                                            ...
                                            <div class="modal fade" id="deleteProgramModal<?php echo e($item->id); ?>"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('program.delete', $item->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="modal fade" id="statusModal<?php echo e($item->id); ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form action="<?php echo e(route('program.toggleStatus', $item->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="status_program" class="form-control">
                                                                        <option value="1"
                                                                            <?php echo e($item->status_program == 1 ? 'selected' : ''); ?>>
                                                                            Aktif
                                                                        </option>
                                                                        <option value="2"
                                                                            <?php echo e($item->status_program == 2 ? 'selected' : ''); ?>>
                                                                            Tidak Aktif
                                                                        </option>
                                                                    </select>
                                                                </div>
    ...
    <div class="modal fade" id="createTimelineModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="createProgramForm" action="<?php echo e(route('program.create')); ?>" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="mitra_ids[]" class="form-control selectpicker" multiple required
                                data-live-search="true">
                                <?php $__currentLoopData = $mitras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mitra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($mitra->id); ?>" data-image="<?php echo e(Storage::url($mitra->file)); ?>">
                                        <?php echo e($mitra->nama_mitra); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btnEditProgram').click(function() {
                ...
                var editUrl = "<?php echo e(route('program.edit', ':id')); ?>".replace(':id', id);
...
<?php echo $__env->make('AdminPage.App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\AdminPage\Program\index.blade.php ENDPATH**/ ?>