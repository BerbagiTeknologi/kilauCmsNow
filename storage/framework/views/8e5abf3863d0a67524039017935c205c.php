...
<?php $__env->startSection('content'); ?>
    ...
    <div class="modal fade" id="createArticleModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="create-article-form" enctype="multipart/form-data"><?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="editArticleModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="edit-article-form" enctype="multipart/form-data"><?php echo csrf_field(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $(function() {
            ...
            /* — CONSTANTS — */
            // const LIST_URL = "<?php echo e(route('lp.article.external.list')); ?>";
            const LIST_URL = "<?php echo e(route('lp.article.external.mylist')); ?>"; // ← ganti ke route baru
            const STORE_URL = "<?php echo e(route('lp.article.external.store')); ?>";
            const CAT_URL = "<?php echo e(route('lp.article.external.kategori')); ?>";
            const IMG_URL = "<?php echo e(route('lp.article.external.uploadImage')); ?>";
            ...
            function loadArtikel(page = 1, search = '') {
                ...
                $.get(LIST_URL, {
                    ...
                    .done(res => {
                        const list = res.data || [];
                        const noImg = "<?php echo e(asset('assets_admin/img/noimage.jpg')); ?>";
...
<?php echo $__env->make('App.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\xxxxx\Documents\sso-kilau\kilauCms\resources\views\LandingPageKilau\Components\article-users.blade.php ENDPATH**/ ?>