...
use App\Http\Controllers\LandingPage\GuestDonorProfileController;
...
use App\Http\Controllers\AdminPage\DonasiAdminController;
...
use App\Http\Controllers\LandingPage\FaqInformasiController;
...
Route::get('/get-users', [LoginController::class, 'getDataUsersProfile'])
    ->middleware('auth.local')
    ->name('getDataUsersProfile');
Route::patch('/get-users', [LoginController::class, 'updateDataUsersProfile'])
    ->middleware('auth.local')
    ->name('profile.update');
Route::post('/loginprosess', [LoginController::class, 'loginProses'])->name('loginProses');
Route::post('/logout', [LoginController::class, 'logout'])->name('logout');
Route::get('/register', [LoginController::class, 'register'])->name('register');
Route::post('/register', [LoginController::class, 'registerProses'])->name('register.store');
...
Route::post('/donasi/{donasi}/verify-payment', [HomeController::class, 'verifyMidtransPayment'])
    ->middleware(['signed', 'throttle:6,1'])
    ->name('donasi.verify-payment');
Route::patch('/guest-donor-profile', [GuestDonorProfileController::class, 'update'])
    ->name('guest-donor-profile.update');
Route::delete('/guest-donor-profile', [GuestDonorProfileController::class, 'destroy'])
    ->name('guest-donor-profile.destroy');
Route::post('/midtrans-notification', [HomeController::class, 'handleMidtransCallback'])->name('midtrans.notification');

	Route::get('/point-referall', [PointReferallController::class, 'pointReferall'])
	    ->middleware('auth.local')
	    ->name('pointreferall');
...
Route::get('/get-berita-users', [BeritaController::class, 'getBeritaUsers'])
    ->middleware('auth.local')
    ->name('getBeritaUsers');
...
// Route::get('/faq', [FaqInformasiController::class, 'index'])->name('FaqInformasi');
...
Route::get('/check-nama-perusahaan', [ColaborasiController::class, 'checkNamaPerusahaan']);
Route::get('/check-email', [ColaborasiController::class, 'checkEmail']);
...
Route::prefix('artikel-external')
    ...
    )->middleware('auth.local')->name('mylist');
    ...
    Route::post('/upload-image-article',
               [ArticlePageExternalController::class,'uploadImage'])->middleware('auth.local')->name('uploadImage');
...
/* Admin Page */
Route::middleware(['auth.local:admin'])->prefix('admin')->group(function () {
    ...
    Route::prefix('donasi')->name('admin.donasi.')->group(function () {
        Route::get('/', [DonasiAdminController::class, 'index'])->name('index');
        Route::get('/chart-data', [DonasiAdminController::class, 'chartData'])->name('chartData');
        Route::get('/filter', [DonasiAdminController::class, 'filter'])->name('filter');
        Route::post('/{donasi}/retry-km12-sync', [DonasiAdminController::class, 'retryKm12Sync'])->name('retryKm12Sync');
        Route::put('/program-mappings/{program}', [DonasiAdminController::class, 'updateProgramMapping'])->name('programMapping.update');
        Route::delete('/{donasi}', [DonasiAdminController::class, 'destroy'])->name('destroy');
    });

    Route::prefix('user-management')->group(function () {
        Route::get('/', [UserManagementController::class, 'index'])->name('admin.users.index');
        Route::put('/{user}/password', [UserManagementController::class, 'updatePassword'])->name('admin.users.password.update');
    });
    ...
    //     Route::get('/', [BeritaAdminController::class, 'index'])->name('berita');
    //     Route::post('/create', [BeritaAdminController::class, 'store'])->name('berita.create');
    //     Route::post('/edit/{id}', [BeritaAdminController::class, 'update'])->name('berita.edit');
    //     Route::delete('/delete/{id}', [BeritaAdminController::class, 'destroy'])->name('berita.delete');
    // });
